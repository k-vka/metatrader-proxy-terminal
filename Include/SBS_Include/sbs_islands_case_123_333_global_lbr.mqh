//================== sbs_islands_case_123_333_global_lbr.mqh ====================/

//========================== Process_ISLANDS_Case_123_333_Global_Open ===========/
//--- ISLANDS signals 365(20X)/465(20X) ---/

void     Process_ISLANDS_Case_123_333_Global_Open()
{
//-------------------------- Check for SELL (365(20X)) -------------------/
...
//================== eof sbs_islands_case_123_333_global_lbr.mqh ================/
